-- Migration: Funções Seguras para P2P (Bypass RLS de Leitura para Estoque Compartilhado)
-- Este arquivo cria funções (RPC) necessárias para contornar o RLS de 'products' de forma segura.

-- 1. Função para buscar os produtos de todas as parcerias ativas que me foram compartilhados
